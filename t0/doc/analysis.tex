...
the capacitor terminals. Applying the Kirchof Voltage Law (KVL), a single
equation for the single loop in the cicuit can be written as
...
Because $V_O$ is the current $i$ can be experessed by 
\begin{equation}
  i(t) = C\frac{dv_O}{dt}.
\end{equation}
...
The forced solution is of the form
\begin{equation}
...
The forced solution is iluustrated in Figure~\ref{fig:forced}. \lipsum[1-1]
